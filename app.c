...
//  cur_temp+= 10; // Tăng 0.1 độ
//    if(cur_temp> 4000) cur_temp = 2000;
//
//    cur_hum++;
//    if(cur_hum > 100) cur_hum = 0;
//   update_adv_data(&sData, advertising_set_handle, cur_temp, cur_hum);
//   app_log("Update -> Temp: %d.%02d, Hum: %d%%\r\n",
//             cur_temp / 100, cur_temp % 100, cur_hum);
}
...
void sl_bt_on_event(sl_bt_msg_t *evt)
{
  ...
  switch (SL_BT_MSG_ID(evt->header)) {
    ...
    case sl_bt_evt_system_boot_id:
      ...
      fill_adv_packet(&sData, FLAG, COMPANY_ID, cur_temp, cur_hum, "CustomADV");
